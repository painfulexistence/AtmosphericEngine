...
void BatchRenderer2D::Init() {
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, m_Data->MaxIndices * sizeof(uint32_t), quadIndices, GL_STATIC_DRAW);
...
void BatchRenderer2D::DrawQuad(
  const glm::mat4& transform, uint32_t textureID, const glm::vec2* texCoords, const glm::vec4& color, int entityID
    ...
    if (textureID == (uint32_t)-1) textureID = m_Data->WhiteTexture;
...
void BatchRenderer2D::DrawTriangle(const glm::vec2& p0, const glm::vec2& p1, const glm::vec2& p2, const glm::vec4& color) {
...
void BatchRenderer2D::DrawTriangleFilled(const glm::vec2& p0, const glm::vec2& p1, const glm::vec2& p2, const glm::vec4& color) {
    DrawTriangleFilled(glm::vec3(p0, 0.0f), glm::vec3(p1, 0.0f), glm::vec3(p2, 0.0f), color);
}

void BatchRenderer2D::DrawTriangleFilled(const glm::vec3& p0, const glm::vec3& p1, const glm::vec3& p2, const glm::vec4& color) {
...
void BatchRenderer2D::DrawRect(const glm::vec2& position, const glm::vec2& size, const glm::vec4& color, float thickness) {
    DrawRect(glm::vec3(position, 0.0f), size, color, thickness);
}

void BatchRenderer2D::DrawRect(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color, float thickness) {
